        ...
        lg:px-8 flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="lg:flex hidden space-x-8">
                {["Home", "About", "Projects", "Contact"].map((item, index) => (
                    ...
                    className="relative text-xl font-bold bg-gradient-to-r from-gray-300 to-gray-100 bg-clip-text text-transparent
                    hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300 group"
                    href="#">
                        {item}
